...
class TileImprovementFunctions(val tile: Tile) {
    ...
    fun canBuildImprovement(improvement: TileImprovement, civInfo: Civilization, unit: MapUnit? = null): Boolean = getImprovementBuildingProblems(improvement, civInfo, unit).none()
     ...
     */
    fun getImprovementBuildingProblems(improvement: TileImprovement, civInfo: Civilization, unit: MapUnit? = null): Sequence<ImprovementBuildingProblem> =
        ImprovementFunctions.getImprovementBuildingProblems(improvement, civInfo, tile, unit)
